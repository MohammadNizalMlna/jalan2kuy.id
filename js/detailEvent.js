const events = [
  {
    ...
    Acara ini bukan sekadar meditasi biasa, melainkan penggabungan ilmu pranic healing dengan teknik meditasi, bertujuan untuk melepaskan stres, mengembalikan keseimbangan tubuh, serta mengisi diri dengan energi positif yang berlimpah dari lingkungan Borobudur. 
    Program ini sangat ideal bagi mereka yang mencari pengalaman wisata wellness dan spiritual.
    <br><br>
    <b>Tanggal mulai dan berakhir : </b> 23 Agustus - 28 Desember 2025 (hari ditentukan)
    <br>
    <b>Tiket Masuk : </b> Tanpa biaya / gratis
    <br>
    <b>Keterangan : </b> Terkadang berbayar (bisa cek langsung pada penyelengara)
    <br>
    <b>Sosial Media : </b> @borobudurculturalcenter atau @borobudurpark.`,
    sideInfo: `
    Borobudur Cultural Center, Area Borobudur Park, Borobudur, Magelang, Jawa Tengah.`
  },
    {
    id: "ramayana",
    ...
    drama yang kuat, dan iringan gamelan yang syahdu.
    Pertunjukan ini bukan sekadar tontonan, melainkan pengalaman mendalam yang menghubungkan penonton dengan warisan budaya luhur Jawa.
    Pada periode akhir tahun ini, suasana hangat Gedung Trimurti (panggung tetutup) akan menjadi saksi bisu keindahan abadi kisah Rama dan Shinta.
    <br><br>
    <b>Tanggal Mulai & Berakhir:</b> 1 November 2025 – 31 Desember 2025 (Rutin setiap hari Selasa, Kamis, dan Sabtu, pukul 19.30–21.00 WIB). 
    <br>
    <b>Tiket Masuk:</b> Beragam, tergantung kelas tempat duduk (mulai dari Kelas 2 hingga VIP).
    <br><br>
    <b>Keterangan:</b> Dapatkan tiket Anda lebih awal untuk memilih kursi terbaik.
    <br>
    <b>Sosial Media:</b> @prambananpark`,
    sideInfo: `
    Harga bervariasi mulai dari Rp150.000 tergantung kelas tempat duduk (Kelas 2, Kelas 1, Khusus, hingga VIP).<br>
    Lokasi: Gedung Trimurti, Kompleks Candi Prambanan, Yogyakarta.`
  },
  {
    id: "sorai",
    ...
    <br><br>
    <b>Tanggal mulai dan berakhir : </b> 30 Desember 2025 - 1 Januari 2026
    <br>
    <b>Tiket Masuk : </b> menyusul
    <br>
    <b>Sosial Media : </b> @soraksoraifest.`,
    sideInfo: `
    Jl. Taman Mini Indonesia Indah, Ceger, Cipayung, Jakarta Timur, DKI Jakarta.`
  }
];
