...
document.getElementById("saveBtn").onclick = () => {
  ...
  eventData.fullDescription = document.getElementById("fullDesc").value.replace(/\n/g, "<br>");
  eventData.sideInfo = document.getElementById("sideInfo").value.replace(/\n/g, "<br>");
